...
* [Aeotec Z-Stick](http://aeotec.com/z-wave-usb-stick) (Gen5) - note the Z-Stick Gen 5 isn't recognized when plugged in directly to the Raspberry Pi 4. Using an unpowered hub seems to allow it to work.
